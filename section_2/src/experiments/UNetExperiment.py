...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER:
            # prediction has shape [BATCH_SIZE, N_CLASSES, PATCH_SIZE, PATCH_SIZE]
            # where N_CLASSES is the number of segmentation classes. Each element
            # prediction[b, c, y, x] represents the raw score (logit) for class c
            # at spatial location (y, x) in the b-th image of the batch.
